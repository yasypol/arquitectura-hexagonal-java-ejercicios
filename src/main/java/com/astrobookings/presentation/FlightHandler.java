...
import com.astrobookings.domain.ports.FlightServicePort;
import com.astrobookings.domain.ports.RocketRepositoryPort;
import com.sun.net.httpserver.HttpExchange;

public class FlightHandler extends BaseHandler {
  
  private final FlightServicePort flightService;

  public FlightHandler() {
    FlightRepositoryPort flightAdapter = RepositoryAdapterFactory.getFlightRepositoryAdapter();
    RocketRepositoryPort rocketAdapter = RepositoryAdapterFactory.getRocketRepositoryAdapter();
    this.flightService = new FlightService(flightAdapter, rocketAdapter);
  }
